...
Backend = str  # "composer" | "entrypoint"
...
class OzonSession:
    ...
    def _request(self, method: str, url: str, body: object = None) -> dict[str, Any]:
        with self._lock:
            status, text = 0, ""
            for attempt in (1, 2):
                self._ensure_http()
                ...
                except Exception:  # ruff: ignore[blind-except] - retried once with a fresh session
                    status, text = 0, ""
